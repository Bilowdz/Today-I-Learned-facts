...
async function loadFacts() {
  const res = await fetch(
    "https://eqqiraaxiskjjniydsti.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVxcWlyYWF4aXNrampuaXlkc3RpIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzYyOTQ4NjksImV4cCI6MTk5MTg3MDg2OX0.WAI6BZHAkfeyEldhHVwKbGMNbJDPlLnKb7dFrTyXTDE",
      },
    }
  );
...
/*
const fact = ["Lisbon is the capital of Purtugal", 2015, true];
console.log(fact);
console.log(fact[2]);
